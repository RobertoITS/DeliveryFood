...
import com.example.deliveryfood.databinding.VariationsCardBinding
...
class VariationsAdapter(private var list: ArrayList<VariationsExtras>): RecyclerView.Adapter<VariationsExtrasViewHolder>() {
